describe('Cards', function () {
    ...
    it('should have a hidden card-reveal', function (done) {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          expect(revealDivPositions.width).toEqual(
            revealCardPositions.width,
            'activator was not as wide as reveal card.'
          );
          expect(revealDivPositions.height).toEqual(
            revealCardPositions.height,
            'activator was not as high as reveal card.'
          );
          expect(revealDivPositions.top).toEqual(
            revealCardPositions.top,
            'activator was not as in the same y as reveal card.'
          );
          expect(revealDivPositions.left).toEqual(
            revealCardPositions.left,
            'activator was not as in the same x as reveal card.'
          );
  ...
  describe('image cards', function () {
    ...
    it('should have an image that fills to full width of card', function () {
      ...
      expect(imagePositions.width).toEqual(
        imageCardPositions.width,
        'image does not fill width of card'
      );
      expect(imagePositions.top).toEqual(
        imageCardPositions.top,
        'image was not as in the same y as card.'
      );
    });
  });
